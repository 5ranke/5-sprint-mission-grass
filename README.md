...
- [x]  다음의 기능 요구 사항을 구현하세요.
    ...
    [[추가 기능 요구 사항](https://www.codeit.kr/topics/sprint-sb-mission-3/lessons/11890)](https://www.codeit.kr/topics/sprint-sb-mission-3/lessons/11890)
...
- 도메인 모델 간 참조 관계를 참고하세요.
    ...
    [[8y8gqa7me-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/8y8gqa7me-image.png&name=8y8gqa7me-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/8y8gqa7me-image.png&name=8y8gqa7me-image.png)
...
[[DTO란?](https://www.notion.so/DTO-240911ad8de08064bac2ea162522ba33?pvs=21)](https://www.notion.so/DTO-240911ad8de08064bac2ea162522ba33?pvs=21)
...
- **의존성**
    - 같은 레이어 간 의존성 주입은 순환 참조 방지를 위해 지양합니다. 다른 Service 대신 필요한 Repository 의존성을 주입해보세요.
        ...
        [[jv2bxgd12-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/jv2bxgd12-image.png&name=jv2bxgd12-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/jv2bxgd12-image.png&name=jv2bxgd12-image.png)
...
- **의존성**
    - 같은 레이어 간 의존성 주입은 순환 참조 방지를 위해 지양합니다. 다른 Service 대신 필요한 Repository 의존성을 주입해보세요.
        ...
        [[usf34n0k1-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/usf34n0k1-image.png&name=usf34n0k1-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/usf34n0k1-image.png&name=usf34n0k1-image.png)
...
- **의존성**
    - 같은 레이어 간 의존성 주입은 순환 참조 방지를 위해 지양합니다. 다른 Service 대신 필요한 Repository 의존성을 주입해보세요.
        ...
        [[5f221mj11-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/5f221mj11-image.png&name=5f221mj11-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/5f221mj11-image.png&name=5f221mj11-image.png)
...
- **의존성**
    - 같은 레이어 간 의존성 주입은 순환 참조 방지를 위해 지양합니다. 다른 Service 대신 필요한 Repository 의존성을 주입해보세요.
        ...
        [[3lpcv58wo-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/3lpcv58wo-image.png&name=3lpcv58wo-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/3lpcv58wo-image.png&name=3lpcv58wo-image.png)
...
- **의존성**
    - 같은 레이어 간 의존성 주입은 순환 참조 방지를 위해 지양합니다. 다른 Service 대신 필요한 Repository 의존성을 주입해보세요.
        ...
        [[dvbyymgav-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/dvbyymgav-image.png&name=dvbyymgav-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/dvbyymgav-image.png&name=dvbyymgav-image.png)
...
- **의존성**
    - 같은 레이어 간 의존성 주입은 순환 참조 방지를 위해 지양합니다. 다른 Service 대신 필요한 Repository 의존성을 주입해보세요.
        ...
        [[wms3box4u-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/wms3box4u-image.png&name=wms3box4u-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/wms3box4u-image.png&name=wms3box4u-image.png)
...
- **의존성**
    - 같은 레이어 간 의존성 주입은 순환 참조 방지를 위해 지양합니다. 다른 Service 대신 필요한 Repository 의존성을 주입해보세요.
        ...
        [[1vjxng9jx-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/1vjxng9jx-image.png&name=1vjxng9jx-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/1vjxng9jx-image.png&name=1vjxng9jx-image.png)
...
- [ ]  지금까지 인터페이스로 설계한 각각의 Repository를 JCF, File로 각각 구현하세요.
    ...
    [[w9rzlpt8k-image.png](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/w9rzlpt8k-image.png&name=w9rzlpt8k-image.png)](https://bakey-api.codeit.kr/api/files/resource?root=static&seqId=11890&version=1&directory=/w9rzlpt8k-image.png&name=w9rzlpt8k-image.png)
